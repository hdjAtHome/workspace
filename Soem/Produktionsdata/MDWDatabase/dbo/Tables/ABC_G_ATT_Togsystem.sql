CREATE TABLE [dbo].[ABC_G_ATT_Togsystem] (
    ...
    CONSTRAINT [PK_ABC_Attribute_Togsystem] PRIMARY KEY CLUSTERED ([AttributeDimension] ASC, [AccountModuleType] ASC, [AccountReference] ASC, [Periode] ASC) WITH (FILLFACTOR = 90)
);
