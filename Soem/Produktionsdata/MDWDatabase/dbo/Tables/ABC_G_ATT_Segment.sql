CREATE TABLE [dbo].[ABC_G_ATT_Segment] (
    ...
    CONSTRAINT [PK_ABC_Attribute_Segment] PRIMARY KEY CLUSTERED ([AttributeDimension] ASC, [AccountModuleType] ASC, [AccountReference] ASC, [Periode] ASC) WITH (FILLFACTOR = 90)
);
