CREATE TABLE [edw].[FT_Nedskriv] (
    ...
    CONSTRAINT [FK_FT_Nedskriv_DIM_Fabrik] FOREIGN KEY ([Dim_Fabrik]) REFERENCES [edw].[Dim_Fabrik] ([Fabrik]),
    CONSTRAINT [FK_FT_Nedskriv_DIM_Materiale] FOREIGN KEY ([Dim_Materiale]) REFERENCES [edw].[Dim_Materiale] ([PK_ID])
);
